...
- qged and MGED edit paths publish transient geometry through neutral GED edit transactions and libbrlobol feature refs.  The former widget-private `QgObolEditPreview` helper and its direct-controller fallback are deleted; multi-view publication is owned by GED.
