...
proc dump_mged_state {fd} {
    ...
    puts $fd "# The size of all axes are specified in"
    ...
    puts $fd ""
    puts $fd "# 0 - do not draw ticked scale on model axes"
    puts $fd "# 1 - draw ticked scale on model axes"
    puts $fd "rset ax model_tick_enable [rset ax model_tick_enable]"
    puts $fd ""
    puts $fd "# tick spacing on model axes, in mm"
    puts $fd "rset ax model_tick_interval [rset ax model_tick_interval]"
    puts $fd ""
    puts $fd "# number of ticks per major tick on model axes"
    puts $fd "rset ax model_ticks_per_major [rset ax model_ticks_per_major]"
    puts $fd ""
