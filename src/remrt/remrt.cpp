...
// C headers (still needed for compatibility)
#include <stdlib.h>
#include <stddef.h>
#include <ctype.h>
#include <signal.h>
...
#define GET_FRAME(p) { \
	...
	memset(static_cast<void*>(p), 0, sizeof(struct frame)); \
	(p)->fr_magic = FRAME_MAGIC; \
	bu_vls_init(&(p)->fr_cmd); \
	bu_vls_init(&(p)->fr_after_cmd); \
    }
...
repaint_fb(struct frame *fr)
{
    ...
    if (fr->fr_filename == nullptr) return;
...
struct pkg_switch pkgswitch[] = {
    { MSG_DIRBUILD_REPLY,	ph_dirbuild_reply,	"Dirbuild ACK", nullptr },
    { MSG_GETTREES_REPLY,	ph_gettrees_reply,	"gettrees ACK", nullptr },
    { MSG_MATRIX,		ph_default,		"Set Matrix", nullptr },
    { MSG_LINES,		ph_default,		"Compute lines", nullptr },
    { MSG_END,			ph_default,		"End", nullptr },
    { MSG_PIXELS,		ph_pixels,		"Pixels", nullptr },
    { MSG_PRINT,		ph_print,		"Log Message", nullptr },
    { MSG_VERSION,		ph_version,		"Protocol version check", nullptr },
    { MSG_CMD,			ph_cmd,			"Run one command", nullptr },
    { 0,			0,			nullptr, nullptr }
};
}
