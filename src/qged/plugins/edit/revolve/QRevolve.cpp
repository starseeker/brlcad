    ...
    : QWidget()
{
    ...
    editor->setObjectName(QStringLiteral("revolve.sharedPrimitiveEditor"));
    layout->addWidget(editor);

    connect(editor, &QgPrimitiveEdit::sessionEvent,
	this, &QRevolve::update_preview);
}


void
QRevolve::setContext(QgPluginContext *ctx)
{
    m_ctx = ctx;
...
void
QRevolve::update_preview(int kindValue, qulonglong UNUSED(revision))
{
...
QRevolve::sync_selection()
{
	...
	const bool isRevolve = !selectedPath.isEmpty() &&
