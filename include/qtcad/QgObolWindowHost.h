...
class QTCAD_EXPORT QgObolWindowHost : public BObolWindowHost {
public:
    ...
    void bindController(BObolViewController *controller);
 ...
 *
 * For BOBOL_HOST_MODE_EMBEDDED, bobol_host_desc::application_context
