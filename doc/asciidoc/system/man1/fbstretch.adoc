...
[source]
----
fbstretch [-a] [-v] [-s _size_] [-w _width_] [-n _height_] [-f _in_fb_]
          [-x _x_scale_] [-y _y_scale_]
          [-S _size_] [-W _width_] [-N _height_] [[-F] _out_fb_]
----
...
Pixel averaging may be meaningless for some images or color maps, in which case sampling should be specified. Images of the Mandelbrot set are a good example of this.
