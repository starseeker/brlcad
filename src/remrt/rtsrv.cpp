...
struct pkg_switch pkgswitch[] = {
    { MSG_DIRBUILD,	ph_dirbuild,	"DirBuild", nullptr },
    { MSG_GETTREES,	ph_enqueue,	"Get Trees", nullptr },
    { MSG_MATRIX,	ph_enqueue,	"Set Matrix", nullptr },
    { MSG_OPTIONS,	ph_enqueue,	"Options", nullptr },
    { MSG_LINES,	ph_enqueue,	"Compute lines", nullptr },
    { MSG_END,		ph_end,		"End", nullptr },
    { MSG_PRINT,	ph_unexp,	"Log Message", nullptr },
    { MSG_LOGLVL,	ph_loglvl,	"Change log level", nullptr },
    { MSG_RESTART,	ph_restart,	"Restart", nullptr },
    { MSG_CD,		ph_cd,		"Change Dir", nullptr },
    { 0,		0,		nullptr, nullptr }
};
}
...
main(int argc, char **argv)
{
     ...
     */
    pcsrv = pkg_open(control_host, tcp_port, "tcp", "", "", pkgswitch, nullptr);
    if (pcsrv == PKC_ERROR) {
...
ph_lines(struct pkg_conn *UNUSED(pc), char *buf)
{
    ...
    info.li_cpusec = rt_read_timer(nullptr, 0);
