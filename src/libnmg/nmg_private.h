...
typedef void (*nmg_plot_anim_upcall_t)(struct bg_vlblock *, int, int);
...
NMG_EXPORT extern void nmg_vlblock_v(struct bg_vlblock *vbp,
				     const struct vertex *v,
				     long *tab,
				     struct bu_list *vlfree);
NMG_EXPORT extern void nmg_vlblock_e(struct bg_vlblock *vbp,
				     const struct edge *e,
				     long *tab,
				     int red,
				     int green,
				     int blue,
				     struct bu_list *vlfree);
NMG_EXPORT extern void nmg_vlblock_eu(struct bg_vlblock *vbp,
...
NMG_EXPORT extern void nmg_vlblock_around_eu(struct bg_vlblock *vbp,
					     const struct edgeuse *arg_eu,
					     long *tab,
					     int fancy,
					     struct bu_list *vlfree,
					     const struct bn_tol *tol);
NMG_EXPORT extern void nmg_vlblock_lu(struct bg_vlblock *vbp,
				      ...
				      int fancy,
				      struct bu_list *vlfree);
NMG_EXPORT extern void nmg_vlblock_fu(struct bg_vlblock *vbp,
				      const struct faceuse *fu,
				      long *tab,
				      int fancy,
				      struct bu_list *vlfree);
NMG_EXPORT extern void nmg_vlblock_s(struct bg_vlblock *vbp,
				     const struct shell *s,
				     int fancy,
				     struct bu_list *vlfree);
NMG_EXPORT extern void nmg_vlblock_r(struct bg_vlblock *vbp,
				     const struct nmgregion *r,
				     int fancy,
				     struct bu_list *vlfree);
NMG_EXPORT extern void nmg_vlblock_m(struct bg_vlblock *vbp,
				     const struct model *m,
				     int fancy,
				     struct bu_list *vlfree);
NMG_EXPORT extern void nmg_pl_edges_in_2_shells(struct bg_vlblock *vbp,
						long *b,
						const struct edgeuse *eu,
						int fancy,
						struct bu_list *vlfree,
