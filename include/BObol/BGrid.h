...
#ifndef BOBOL_BGRID_H
#define BOBOL_BGRID_H
...
class BOBOL_EXPORT SoBRLGrid : public SoSeparator
{
...
BOBOL_EXPORT extern int bobol_grid_configure_from_view(
    SoBRLGrid *grid,
...
BOBOL_EXPORT extern int bobol_grid_configure_from_view_context(
    SoBRLGrid *grid,
    const struct bv_grid_state *state,
    const void *view_ctx);
