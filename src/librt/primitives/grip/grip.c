 ...
 */
C_DECL int
rt_grp_plot(struct bu_list *vhead, struct rt_db_internal *ip, const struct bg_tess_tol *UNUSED(ttol), const struct bn_tol *UNUSED(tol), const struct bv_view_info *UNUSED(info))
{
    struct rt_grip_internal *gip;
    ...
    RT_ADD_VLIST(vlfree, vhead, x_1, RT_VLIST_LINE_MOVE); /* the base */
    ...
    RT_ADD_VLIST(vlfree, vhead, x_1,  RT_VLIST_LINE_MOVE); /* the sides */
