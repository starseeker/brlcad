/*                 B V L I S T S H A P E . H
 * BRL-CAD
 *
 * Copyright (c) 2026 United States Government as represented by
 * the U.S. Army Research Laboratory.
 */
/** @file BObol/BVListShape.h */

#ifndef BOBOL_BVLISTSHAPE_H
#define BOBOL_BVLISTSHAPE_H
...
class BOBOL_EXPORT SoBRLVListShape : public SoShape {
