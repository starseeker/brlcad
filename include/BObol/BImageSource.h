/*                B I M A G E S O U R C E . H
 * BRL-CAD
 *
 * Copyright (c) 2026 United States Government as represented by
 * the U.S. Army Research Laboratory.
 */
/** @file BObol/BImageSource.h */

#ifndef BOBOL_BIMAGESOURCE_H
#define BOBOL_BIMAGESOURCE_H
...
class BOBOL_EXPORT SoBRLImageSource : public SoNode {
