...
int
bobol_grid_configure_from_view(SoBRLGrid *grid,
...
int
bobol_grid_configure_from_view_context(SoBRLGrid *grid,
	const struct bv_grid_state *state,
	const void *view_ctx)
{
    ...
    return bobol_grid_configure_from_view(grid, state, model2view,
					    bv_scale_get(view),
