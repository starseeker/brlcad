 ...
 *
 * NOTE: from libbg's perspective, plot3.h is a stand-alone public header that
 * does not use any other library functionality beyond libbu/vmath support.
 * The default plot3_* implementation is compiled by src/libbg/plot3.c.  The
 * PLOT3_IMPLEMENTATION and PLOT_PREFIX_STR mechanism below remains available
 * for private, prefixed local implementations such as bg_plot3_* helpers.
 *
