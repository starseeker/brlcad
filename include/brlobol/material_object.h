/*               M A T E R I A L _ O B J E C T . H
 * BRL-CAD
 *
 * Copyright (c) 2026 United States Government as represented by
 * the U.S. Army Research Laboratory.
 */
/** @file brlobol/material_object.h */

#ifndef BRLOBOL_MATERIAL_OBJECT_H
#define BRLOBOL_MATERIAL_OBJECT_H
...
class BRLOBOL_EXPORT SoBRLMaterialObject : public SoNode {
...
#endif /* BRLOBOL_MATERIAL_OBJECT_H */
