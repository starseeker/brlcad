...
/** @file terrascape.c
 *
 * Terrascape volumetric tessellation implementation for DSP primitives.
 * This is a minimal implementation that generates watertight volumetric
 * meshes from DSP height field data.
 *
 */
