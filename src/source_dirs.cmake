...
set_deps(libnmg     "libbg;libbn;libbu")
set_deps(libbrep    "libbg;libbu")
set_deps(librt      "libbrep;libnmg;libbv;libbg;libbn;libbu")
set_deps(libwdb     "librt;libbn;libbu")
set_deps(libpkg     "")
set_deps(libicv     "libbn;libbu")
set_deps(libimgstream "libicv;libbn;libpkg;libbu")
set_deps(libbrlobol "libwdb;librt;libimgstream;libbg;libbu")
set_deps(libgcv     "libwdb;libbn;libbu")
set_deps(libanalyze "librt;libbg;libbn;libbu")
set_deps(liboptical "librt;libbn;libbu")
set_deps(libdm      "librt;libicv;libbn;libpkg;libbu")
set_deps(libged     "libbrlobol;libimgstream;libicv;libanalyze;libwdb;liboptical;libbu")
set_deps(libfft     "")
set_deps(libpc      "")
set_deps(libqtcad   "libbrlobol;libged;libbg;libbn;libbu")
set_deps(libtclcad  "libged;libimgstream;libpkg;libbn;libbu")
...
set_deps(fb         "libimgstream;libbu")
set_deps(fbserv     "libimgstream;libpkg;libbu")
set_deps(gtools     "libged")
set_deps(nirt       "libanalyze")
set_deps(proc-db    "libwdb")
set_deps(rt         "librt;liboptical;libimgstream;libicv")
set_deps(art        "libged;libimgstream")
set_deps(shapes     "libged")
set_deps(sig        "libfft;libbu")
set_deps(util       "libimgstream;libicv;libwdb")
set_deps(qged       "libqtcad")
set_deps(external   "libwdb")
set_deps(remrt      "libimgstream;liboptical")
