...
\* Include the all-admitted boundary as well as constrained budgets.  The old
\* 1..3 domain made Complete unreachable and therefore left that transition
\* untested even though it was named in Next and the fairness specification.
MaximumBudget == Cost(Prominent) + Cardinality(Ordinary)
InitialBudgets == 1..MaximumBudget
...
Terminal == ~inputOpen /\ ~allocationPending
