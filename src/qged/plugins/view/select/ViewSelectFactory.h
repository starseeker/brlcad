 ...
 * Implements IQgViewEventFilter: installs CADViewSelector's semantic input
 * profile on the active QgView endpoint while the tool is selected.
 */
...
/* Tool: wraps CADViewSelector in the QgToolBase + endpoint-input lifecycle. */
