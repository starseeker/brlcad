/*       V I E W _ F E A T U R E _ I N T E R N A L . H
 * BRL-CAD
 *
 ...
 */
/** @file ged/view_feature_internal.h
 *
 * Uninstalled compatibility surface for in-tree annotation producers and
 * edit-preview adapters.  New producers publish typed geometry through
 * ged/view_feature_batch.h and use ged/view_feature.h only for queries.
 */

#ifndef GED_VIEW_FEATURE_INTERNAL_H
#define GED_VIEW_FEATURE_INTERNAL_H
...
#endif /* GED_VIEW_FEATURE_INTERNAL_H */
