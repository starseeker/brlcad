	...
	int reset)
{
	 ...
	 * forever.  Eight 1.25x probes can span almost a 6x discrete jump; faster
	 * frames use the existing 2x/4x growth tiers. */
	...
	static constexpr unsigned int maxStableCalibrationProbes = 8;
