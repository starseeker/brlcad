...
test_input_context(void)
{
    ...
    BRLObolInputBinding semantic_binding;
    semantic_binding.eventType = BRLOBOL_INPUT_POINTER_RELEASE;
    semantic_binding.key = BRLOBOL_INPUT_ANY;
    semantic_binding.button = 0;
    semantic_binding.requiredModifiers = BRLOBOL_INPUT_MOD_NONE;
    semantic_binding.forbiddenModifiers = BRLOBOL_INPUT_MOD_SHIFT |
