...
struct dm_impl {
    ...
    int (*dm_drawVList)(struct dm *dmp, bg_vlist *vp);
    int (*dm_drawVListHiddenLine)(struct dm *dmp, bg_vlist *vp);
    int (*dm_draw)(struct dm *dmp, bg_vlist *(*callback_function)(void *), void **data);	/**< @brief formerly dmr_object */
