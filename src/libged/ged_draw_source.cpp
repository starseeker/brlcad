...
int
ged_view_edit_primitive_wireframe_replace(
    struct ged_view_context *view_ctx,
    ...
    const struct bn_tol *tol)
{
    ...
    if (ged_view_edit_ref_is_null(ref) || !ip)
	return 0;
    ...
    ret = ged_view_edit_points_replace(view_ctx, ref,
	    GED_VIEW_EDIT_GEOMETRY_TRANSIENT_PREVIEW,
