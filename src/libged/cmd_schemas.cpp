...
static const struct bu_opt_cmd_desc view_subcommands[] = {
    ...
    {"annotation", "Create and edit user annotation objects", NULL, NULL, raw_args_operands, NULL},
    {"center", "Get or set the view center", NULL, NULL, raw_args_operands, NULL},
    {"db", "Manage database display objects", NULL, NULL, raw_args_operands, NULL},
