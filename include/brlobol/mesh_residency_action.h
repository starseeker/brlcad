/*           M E S H _ R E S I D E N C Y _ A C T I O N . H
 * BRL-CAD
 *
 * Copyright (c) 2026 United States Government as represented by
 * the U.S. Army Research Laboratory.
 */
/** @file brlobol/mesh_residency_action.h */

#ifndef BRLOBOL_MESH_RESIDENCY_ACTION_H
#define BRLOBOL_MESH_RESIDENCY_ACTION_H
...
class BRLOBOL_EXPORT SoBRLMeshResidencyAction : public SoAction {
...
#endif /* BRLOBOL_MESH_RESIDENCY_ACTION_H */
