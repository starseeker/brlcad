...
static struct cmdtab mged_cmdtab[] = {
    ...
    {MGED_CMD_MAGIC, "aet", cmd_ged_view_wrapper, ged_exec_aet, NULL},
    ...
    {MGED_CMD_MAGIC, "dplot", cmd_ged_plain_wrapper, ged_exec_dplot, NULL},
    ...
    {MGED_CMD_MAGIC, "ert", cmd_ged_display_wrapper, ged_exec_ert, NULL},
    ...
    {MGED_CMD_MAGIC, "eye", cmd_ged_view_wrapper, ged_exec_eye, NULL},
    {MGED_CMD_MAGIC, "eye_pos", cmd_ged_view_wrapper, ged_exec_eye_pos, NULL},
    ...
    {MGED_CMD_MAGIC, "fb2pix", cmd_ged_display_wrapper, ged_exec_fb2pix, NULL},
    {MGED_CMD_MAGIC, "fbclear", cmd_ged_display_wrapper, ged_exec_fbclear, NULL},
    ...
    {MGED_CMD_MAGIC, "find_pipe_pnt", cmd_ged_plain_wrapper, ged_exec_find_pipe_pnt, NULL},
    ...
    {MGED_CMD_MAGIC, "get_display_list", f_get_display_list, GED_FUNC_PTR_NULL, NULL},
    ...
    {MGED_CMD_MAGIC, "group", cmd_ged_plain_wrapper, ged_exec_group, NULL},
    ...
    {MGED_CMD_MAGIC, "how", cmd_ged_plain_wrapper, ged_exec_how, NULL},
    {MGED_CMD_MAGIC, "human", cmd_ged_plain_wrapper, ged_exec_human, NULL},
    ...
    {MGED_CMD_MAGIC, "log", cmd_ged_plain_wrapper, ged_exec_log, NULL},
    ...
    {MGED_CMD_MAGIC, "metaball_delete_pnt", cmd_ged_plain_wrapper, ged_exec_metaball_delete_pnt, NULL},
    {MGED_CMD_MAGIC, "metaball_move_pnt", cmd_ged_plain_wrapper, ged_exec_metaball_move_pnt, NULL},
    ...
    {MGED_CMD_MAGIC, "move", cmd_ged_plain_wrapper, ged_exec_move, NULL},
    {MGED_CMD_MAGIC, "move_all", cmd_ged_plain_wrapper, ged_exec_move_all, NULL},
    {MGED_CMD_MAGIC, "move_arb_edge", cmd_ged_plain_wrapper, ged_exec_move_arb_edge, NULL},
    {MGED_CMD_MAGIC, "move_arb_face", cmd_ged_plain_wrapper, ged_exec_move_arb_face, NULL},
    ...
    {MGED_CMD_MAGIC, "nmg_kill_f", cmd_ged_plain_wrapper, ged_exec_nmg_kill_f, NULL},
    {MGED_CMD_MAGIC, "nmg_kill_v", cmd_ged_plain_wrapper, ged_exec_nmg_kill_v, NULL},
    {MGED_CMD_MAGIC, "nmg_make_v", cmd_ged_plain_wrapper, ged_exec_nmg_make_v, NULL},
    {MGED_CMD_MAGIC, "nmg_mm", cmd_ged_plain_wrapper, ged_exec_nmg_mm, NULL},
    {MGED_CMD_MAGIC, "nmg_move_v", cmd_ged_plain_wrapper, ged_exec_nmg_move_v, NULL},
    ...
    {MGED_CMD_MAGIC, "nmg_cmface", cmd_ged_plain_wrapper, ged_exec_nmg_cmface, NULL},
    ...
    {MGED_CMD_MAGIC, "ocenter", cmd_ged_plain_wrapper, ged_exec_ocenter, NULL},
    ...
    {MGED_CMD_MAGIC, "orient", cmd_ged_view_wrapper, ged_exec_orient, NULL},
    ...
    {MGED_CMD_MAGIC, "orotate", cmd_ged_plain_wrapper, ged_exec_orotate, NULL},
    {MGED_CMD_MAGIC, "oscale", f_sc_obj, GED_FUNC_PTR_NULL, NULL},
    {MGED_CMD_MAGIC, "otranslate", cmd_ged_plain_wrapper, ged_exec_otranslate, NULL},
    ...
    {MGED_CMD_MAGIC, "pipe_prepend_pnt", cmd_ged_plain_wrapper, ged_exec_pipe_prepend_pnt, NULL},
    {MGED_CMD_MAGIC, "pix2fb", cmd_ged_display_wrapper, ged_exec_pix2fb, NULL},
    {MGED_CMD_MAGIC, "plot", cmd_ged_plain_wrapper, ged_exec_plot, NULL},
    {MGED_CMD_MAGIC, "pmat", cmd_ged_view_wrapper, ged_exec_pmat, NULL},
    {MGED_CMD_MAGIC, "pmodel2view", cmd_ged_plain_wrapper, ged_exec_pmodel2view, NULL},
    {MGED_CMD_MAGIC, "png", cmd_ged_plain_wrapper, ged_exec_png, NULL},
    {MGED_CMD_MAGIC, "png2fb", cmd_ged_display_wrapper, ged_exec_png2fb, NULL},
    ...
    {MGED_CMD_MAGIC, "preview", cmd_ged_display_wrapper, ged_exec_preview, NULL},
    {MGED_CMD_MAGIC, "print", cmd_ged_plain_wrapper, ged_exec_print, NULL},
    {MGED_CMD_MAGIC, "process", cmd_ged_plain_wrapper, ged_exec_process, NULL},
    {MGED_CMD_MAGIC, "protate", cmd_ged_plain_wrapper, ged_exec_protate, NULL},
    {MGED_CMD_MAGIC, "postscript", f_postscript, GED_FUNC_PTR_NULL, NULL},
    {MGED_CMD_MAGIC, "ps", cmd_ps, GED_FUNC_PTR_NULL, NULL},
    {MGED_CMD_MAGIC, "pscale", cmd_ged_plain_wrapper, ged_exec_pscale, NULL},
    {MGED_CMD_MAGIC, "pset", cmd_ged_plain_wrapper, ged_exec_pset, NULL},
    {MGED_CMD_MAGIC, "ptranslate", cmd_ged_plain_wrapper, ged_exec_ptranslate, NULL},
    ...
    {MGED_CMD_MAGIC, "quat", cmd_ged_view_wrapper, ged_exec_quat, NULL},
    ...
    {MGED_CMD_MAGIC, "rect", cmd_ged_view_wrapper, ged_exec_rect, NULL},
    {MGED_CMD_MAGIC, "red", f_red, GED_FUNC_PTR_NULL, NULL},
    {MGED_CMD_MAGIC, "redraw", cmd_ged_plain_wrapper, ged_exec_redraw, NULL},
    {MGED_CMD_MAGIC, "refresh", f_refresh, GED_FUNC_PTR_NULL, NULL},
    {MGED_CMD_MAGIC, "regdef", cmd_ged_plain_wrapper, ged_exec_regdef, NULL},
    {MGED_CMD_MAGIC, "region", cmd_ged_plain_wrapper, ged_exec_region, NULL},
    ...
    {MGED_CMD_MAGIC, "remove", cmd_ged_plain_wrapper, ged_exec_remove, NULL},
    ...
    {MGED_CMD_MAGIC, "rmap", cmd_ged_plain_wrapper, ged_exec_rmap, NULL},
    {MGED_CMD_MAGIC, "rmat", cmd_ged_view_wrapper, ged_exec_rmat, NULL},
    ...
    {MGED_CMD_MAGIC, "rot_about", cmd_ged_view_wrapper, ged_exec_rot_about, NULL},
    {MGED_CMD_MAGIC, "rot_point", cmd_ged_plain_wrapper, ged_exec_rot_point, NULL},
    {MGED_CMD_MAGIC, "rotate_arb_face", cmd_ged_plain_wrapper, ged_exec_rotate_arb_face, NULL},
    {MGED_CMD_MAGIC, "rotobj", f_rot_obj, GED_FUNC_PTR_NULL, NULL},
    {MGED_CMD_MAGIC, "rrt", cmd_rrt, GED_FUNC_PTR_NULL, NULL},
    {MGED_CMD_MAGIC, "rselect", cmd_ged_plain_wrapper, ged_exec_rselect, NULL},
    ...
    {MGED_CMD_MAGIC, "rtwizard", cmd_ged_plain_wrapper, ged_exec_rtwizard, NULL},
    ...
    {MGED_CMD_MAGIC, "sdata_lines", cmd_ged_plain_wrapper, ged_exec_sdata_lines, NULL},
    ...
    {MGED_CMD_MAGIC, "sphgroup", cmd_ged_plain_wrapper, ged_exec_sphgroup, NULL},
    ...
    {MGED_CMD_MAGIC, "ypr", cmd_ged_view_wrapper, ged_exec_ypr, NULL},
